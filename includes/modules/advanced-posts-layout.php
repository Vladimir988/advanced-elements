...
class Advanced_Posts_Layout extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Advanced Posts', 'advanced-elements' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			'custom_post_layout',
			[
				'label'   => esc_html__( 'Posts Layout', 'advanced-elements' ),
		...
		$this->add_control(
			'post_layout',
			[
				'label'       => esc_html__( 'Post Layout Type', 'advanced-elements' ),
				'type'        => Controls_Manager::SELECT,
				'default'     => '',
				'options'     => $this->get_templates_names(),
				'label_block' => true,
				'description' => __( 'You can add own template in your theme. Add file with template in <strong>.php</strong> format into <strong>advanced-elements/posts/</strong> folder in your theme. Example in: <strong>plugins/advanced-elements/templates/post-templates</strong>', 'advanced-elements' ),
			]
		);
		$this->add_control(
			'post_type',
			[
				'label'   => esc_html__( 'Post Type', 'advanced-elements' ),
				'type'    => Controls_Manager::SELECT,
				'default' => 'post',
		...
		$this->add_control(
			'posts_query_post',
			[
				'label'      => esc_html__( 'Query posts by', 'advanced-elements' ),
				'type'       => Controls_Manager::SELECT,
				'default'    => 'latest',
				'options'    => array(
					'latest'   => esc_html__( 'Latest Posts', 'advanced-elements' ),
					'ids'      => esc_html__( 'By Specific IDs', 'advanced-elements' ),
					'category' => esc_html__( 'Category', 'advanced-elements' ),
				),
				'condition'   => array(
					'post_type' => 'post',
				),
		...
		$this->add_control(
			'post_ids',
			[
				'label'     => esc_html__( 'Set comma seprated IDs list (10, 22, 19 etc.)', 'advanced-elements' ),
		...
		$this->add_control(
			'post_cat',
			[
				'label'     => esc_html__( 'Choose category', 'advanced-elements' ),
		...
		$this->add_control(
			'posts_query_page',
			[
				'label'       => esc_html__( 'Set Page ID', 'advanced-elements' ),
				'type'        => Controls_Manager::TEXT,
				'default'     => '',
				'condition'   => array(
					'post_type' => 'page',
		...
		$this->add_control(
			'posts_query_team',
			[
				'label'       => esc_html__( 'Choose group', 'advanced-elements' ),
				'type'        => Controls_Manager::SELECT2,
				'multiple'    => true,
				'default'     => '',
		...
		$this->add_control(
			...
			[
				'label'       => esc_html__( 'Choose services', 'advanced-elements' ),
				'type'        => Controls_Manager::SELECT2,
				'multiple'    => true,
				'default'     => '',
		...
		$this->add_control(
			...
			[
				'label'       => esc_html__( 'Choose testimonials', 'advanced-elements' ),
				'type'        => Controls_Manager::SELECT2,
				'multiple'    => true,
				'default'     => '',
		...
		$this->add_control(
			'query_image',
			[
				'label'   => esc_html__( 'Choose image size', 'advanced-elements' ),
				'type'    => Controls_Manager::SELECT,
				'default' => 'thumbnail',
		...
		$this->add_control(
			'order',
			[
				'label'   => esc_html__( 'Order By', 'advanced-elements' ),
				'type'    => Controls_Manager::SELECT,
				'default' => 'DESC',
				'options' => array(
					'DESC'  => esc_html__( 'DESC', 'advanced-elements' ),
					'ASC'   => esc_html__( 'ASC', 'advanced-elements' ),
				),
			]
		);
		$this->add_control(
			'title_trimmed',
			[
				'label'        => esc_html__( 'Title Word Trim', 'advanced-elements' ),
		...
		$this->add_control(
			'title_length',
			[
				'label'     => esc_html__( 'Title Length', 'advanced-elements' ),
		...
		$this->add_control(
			...
			[
				'label'           => esc_html__( 'Title Trimmed Ending', 'advanced-elements' ),
				'type'            => Controls_Manager::TEXT,
				'default'         => '...',
				'condition'       => array(
					'title_trimmed' => 'yes',
		...
		$this->add_control(
			'excerpt_show',
			[
				'label'        => esc_html__( 'Show Excerpt', 'advanced-elements' ),
				'label_on'     => esc_html__( 'Yes', 'advanced-elements' ),
				'label_off'    => esc_html__( 'No', 'advanced-elements' ),
				'type'         => Controls_Manager::SWITCHER,
				'return_value' => 'yes',
		...
		$this->add_control(
			'excerpt_length',
			[
				'label'     => esc_html__( 'Excerpt Length', 'advanced-elements' ),
				'type'      => Controls_Manager::NUMBER,
				'default'   => 35,
				'min'       => 1,
				'max'       => 200,
		...
		$this->add_control(
			'excerpt_ending_text',
			[
				'label'          => esc_html__( 'Excerpt Trimmed Ending', 'advanced-elements' ),
				'type'           => Controls_Manager::TEXT,
				'default'        => '...',
				'condition'      => array(
					'excerpt_show' => 'yes',
		...
		$this->add_control(
			'number',
			[
				'label'   => esc_html__( 'Posts Per Page', 'advanced-elements' ),
				'type'    => Controls_Manager::NUMBER,
				'default' => 3,
				'min'     => -1,
				'max'     => 30,
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Owl carousel', 'advanced-elements' ),
				'tab'   => Controls_Manager::TAB_LAYOUT,
			]
		);
		$this->add_control(
			'owl_carousel',
			[
				'label'        => esc_html__( 'Enable carousel?', 'advanced-elements' ),
				'label_on'     => esc_html__( 'Yes', 'advanced-elements' ),
				'label_off'    => esc_html__( 'No', 'advanced-elements' ),
				'type'         => Controls_Manager::SWITCHER,
				'return_value' => 'yes',
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Column', 'advanced-elements' ),
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors'   => array(
					'{{WRAPPER}} ' . '.advanced_posts_wrapper .advanced_posts_item' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'render_type' => 'template',
				'selectors'   => array(
					'{{WRAPPER}} ' . '.advanced_posts_wrapper .advanced_posts_item' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
			]
		);
	}
	...
	protected function owl_settings_callback( $content = null, $settings = array() ) {
		if('yes' !== $settings['owl_carousel']) {
			...
			return '<div class="advanced_posts_wrapper' . $current_template_name . '">' . $content . '</div>';
		}
		...
		$current_template_name = $this->get_current_template_name();
		return sprintf(
			'<div class="advanced_posts_wrapper posts-owl owl-carousel owl-theme' . $current_template_name . '" data-posts-options="%1$s">%2$s</div>',
	...
	public function do_shortcode() {
		if( '' !== $this->get_settings( 'post_layout' ) ) {
			$template_path = $this->get_settings( 'post_layout' );
		}
	...
	public function get_templates_names() {
		...
		$templates        = $this->get_templates_from_path( advanced_elements()->plugin_path( 'templates/post-templates/' ) );
		$parent_templates = $this->get_templates_from_path( get_template_directory() . '/' . advanced_elements()->template_path() . 'posts/' );
		if ( get_stylesheet_directory() !== get_template_directory() ) {
			$child_templates = $this->get_templates_from_path( get_stylesheet_directory() . '/' . advanced_elements()->template_path() . 'posts/' );
		} else {
			$child_templates = array();
		}

		$scandir = array_merge( $templates, $parent_templates, $child_templates );
		foreach( $scandir as $dir ) {
			$dir = str_replace( '\\', '/', $dir );
			$result[$dir] = basename( str_replace( '.php', '', strtolower( $dir ) ) );
		}
		return $result;
	}

	public function get_templates_from_path( $path = null ) {
		if ( ! file_exists( $path ) ) {
			return array();
		}
		$result = array();
	...
	public function get_images() {
		...
		return array_merge( array( 'full' => esc_html__( 'Full', 'advanced-elements' ), ), $result );
	}
	...
	public function get_default_template() {
		...
		while ( $query->have_posts() ) {
			...
			/*==============================================================*/
				...
				$author_img        = get_avatar_url( $author_email, 75 );
			...
			<div class="advanced_posts_item <?php echo $columns; ?>">
				...
				<a class="btn" href="<?php echo $permalink; ?>"><?php _e('Read More', 'advanced-elements'); ?></a>
				<!-- ---------------------- Template End ------------------------ -->
